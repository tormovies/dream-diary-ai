                                ...
                                <div class="flex flex-wrap items-center justify-center md:justify-end gap-3">
                                    <label class="flex items-start gap-2 cursor-pointer text-sm text-gray-700 dark:text-gray-300">
                                        ...
                                        <div class="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                                            ...
                                            <a href="https://www.snovidec.ru/articles/pravila-publikatsii-snov#pravila" target="_blank" rel="noopener" class="text-purple-600 dark:text-purple-400 hover:underline">что это значит?</a>
                                        </div>
                                    </label>
                                    <button type="submit" 
                                            id="submitBtn"
