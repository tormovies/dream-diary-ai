                            ...
                            <form method="POST" action="{{ route('dream-analyzer.store') }}" id="analyzerForm">
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea id="dream_description" 
                                             ...
                                             minlength="10"
                                             maxlength="10000"
                                             placeholder="Опишите ваш сон максимально подробно. Если снов несколько, разделите их двумя пробелами или пронумеруйте. Постарайтесь описать всё, что помните - детали, эмоции, цвета, звуки, ощущения. Чем больше контекста вы предоставите, тем точнее будет анализ.">{{ old('dream_description') }}</textarea>
                                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                        <i class="fas fa-info-circle mr-1"></i>
                                        Если снов несколько, разделите их двумя пробелами или пронумеруйте. Постарайтесь описать максимально всё, что помните, а не одно слово, потому что ваш контекст важен для точного анализа.
                                    </p>
