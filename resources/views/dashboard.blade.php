            ...
            <main class="space-y-6 w-full" 
                  ...
                  x-init="$watch('viewMode', value => localStorage.setItem('reportsViewMode', value))">
                    ...
                    @if($reports->count() > 0)
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden card-shadow border border-gray-200 dark:border-gray-700" :class="{ 'hidden': viewMode === 'grid', 'md:block': viewMode === 'table' }">
