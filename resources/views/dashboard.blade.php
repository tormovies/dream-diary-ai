                                ...
                                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm card-shadow border border-gray-200 dark:border-gray-700 relative">
                                    <div class="p-6">
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <!-- Остальные действия -->
                                            <div class="grid grid-cols-4 gap-2 pt-2 border-t border-gray-200 dark:border-gray-700">
                                                <a href="{{ route('reports.show', $report) }}"
                                                   target="_blank" rel="noopener noreferrer"
                                                   class="inline-flex min-h-[40px] items-center justify-center rounded-lg border border-blue-200 bg-blue-50 px-2 py-2 text-xs font-medium text-blue-700 transition-colors hover:bg-blue-100 dark:border-blue-800 dark:bg-blue-900/40 dark:text-blue-300 dark:hover:bg-blue-900/60 whitespace-nowrap">
                                                    Просмотр
                                                </a>
                                                <a href="{{ route('reports.edit', $report) }}"
                                                   class="inline-flex min-h-[40px] items-center justify-center rounded-lg border border-green-200 bg-green-50 px-2 py-2 text-xs font-medium text-green-700 transition-colors hover:bg-green-100 dark:border-green-800 dark:bg-green-900/40 dark:text-green-300 dark:hover:bg-green-900/60 whitespace-nowrap">
                                                    Изменить
                                                </a>
                                                @if($report->status === 'published' && $report->hasAnalysis())
                                                    <a href="{{ route('reports.analysis', $report) }}"
                                                       class="inline-flex min-h-[40px] items-center justify-center rounded-lg border border-purple-200 bg-purple-50 px-2 py-2 text-xs font-medium text-purple-700 transition-colors hover:bg-purple-100 dark:border-purple-800 dark:bg-purple-900/40 dark:text-purple-300 dark:hover:bg-purple-900/60 whitespace-nowrap">
                                                        Анализ
                                                    </a>
                                                @elseif($report->status === 'published')
                                                    <a href="{{ route('reports.show', $report) }}"
                                                       class="inline-flex min-h-[40px] items-center justify-center rounded-lg border border-gray-200 bg-gray-50 px-2 py-2 text-xs font-medium text-gray-500 transition-colors hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 whitespace-nowrap">
                                                        Анализ
                                                    </a>
                                                @else
                                                    <a href="#"
                                                       onclick="alert('Чтобы проанализировать Сон/Отчет сначала опубликуйте его. Доступен он будет только тем кто указан в настройках Отчёта.'); return false;"
                                                       class="inline-flex min-h-[40px] items-center justify-center rounded-lg border border-gray-200 bg-gray-50 px-2 py-2 text-xs font-medium text-gray-500 transition-colors hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 whitespace-nowrap">
                                                        Анализ
                                                    </a>
                                                @endif
                                                ...
                                                <form action="{{ route('reports.destroy', $report) }}"
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="inline-flex min-h-[40px] w-full items-center justify-center rounded-lg border border-red-200 bg-red-50 px-2 py-2 text-xs font-medium text-red-700 transition-colors hover:bg-red-100 dark:border-red-800 dark:bg-red-900/40 dark:text-red-300 dark:hover:bg-red-900/60 whitespace-nowrap">
                                                        Удалить
                                                    </button>
                                                </form>
                                            </div>
