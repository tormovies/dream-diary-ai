<p {{ $attributes->merge(['class' => 'text-sm text-gray-500 dark:text-gray-400']) }}>
    ...
    При запуске анализа текст сна и указанный контекст передаются в сервис искусственного интеллекта для формирования результата.
    Передача осуществляется за пределы Российской Федерации.
