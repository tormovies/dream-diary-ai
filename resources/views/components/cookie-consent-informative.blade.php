<div id="cookie-informative-banner"
    ...
    <div class="mx-auto flex w-full max-w-2xl flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
        <p class="text-center text-sm text-gray-700 dark:text-gray-200 sm:text-left">
        ...
        <button type="button"
                ...
                class="shrink-0 rounded-lg bg-purple-600 px-4 py-2 text-sm font-medium text-white hover:bg-purple-700 dark:bg-purple-500 dark:hover:bg-purple-600">
            Понятно
        </button>
    </div>
</div>
