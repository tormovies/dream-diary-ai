{{-- Полная загрузка счётчика (админка и контексты без отложенного согласия) --}}
@if(($metrikaId ?? '') !== '')
...
<script type="text/javascript">
    ...
    ym({{ $metrikaId }}, 'init', {ssr:true, webvisor:false, clickmap:true, accurateTrackBounce:true, trackLinks:true});
</script>
