...
<div class="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 min-w-0">
    <article class="bg-white dark:bg-gray-800 rounded-2xl p-5 sm:p-8 card-shadow border border-gray-200 dark:border-gray-700 prose prose-gray dark:prose-invert max-w-none">
        ...
        <p><strong>Аналитика и рекламные пиксели.</strong> Позволяют собирать обезличенную статистику посещений и могут включать
            сторонние скрипты (например, Яндекс.Метрика), а также фрагменты кода, размещённые оператором в административной панели
            в разделе рекламы/аналитики. Такие технологии подключаются только после вашего отдельного согласия в баннере cookie.</p>

        <h2 class="text-lg font-semibold text-gray-900 dark:text-white mt-8">4. Как изменить выбор</h2>
        <p>
            Вы можете принять все категории, выбрать только обязательные или открыть «Настройки cookie» в футере сайта.
        ...
        <p>Политика может обновляться. Номер редакции и дата указаны в начале документа. После обновления версии политики
            Сервис может запросить повторный выбор категорий cookie.</p>
