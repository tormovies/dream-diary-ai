    ...
    <div class="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="profile-grid w-full">
                ...
                <aside class="space-y-6">
                    ...
                    <!-- Карточка пользователя (скрыта на мобильной) -->
                    <div class="hidden md:block bg-white dark:bg-gray-800 rounded-2xl p-6 card-shadow border border-gray-200 dark:border-gray-700">
                ...
                <aside class="space-y-6">
                    ...
                    <!-- Статистика проекта (скрыта на мобильной) -->
