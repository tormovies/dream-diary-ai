            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                        <i class="fas fa-code mr-2"></i>Вставки кода на сайте
                    </h3>
                    ...
                    <form method="POST" action="{{ route('admin.ad.update') }}">
                        ...
                        <div class="form-group mb-6">
                            <label for="dream_analyzer_ad_code" class="form-label">Код на странице толкования (ожидание)</label>
                        ...
                        <div class="form-group mb-6">
                            <label for="dream_analyzer_ad_code_results" class="form-label">Код на странице толкования (результат)</label>
                        ...
                        <div class="form-group mb-6">
                            <label for="global_head_ad_code" class="form-label">Доп. код в &lt;head&gt; (необязательно)</label>
                            ...
                            <div class="form-hint mt-1">Подключается на публичных страницах только после согласия на аналитику вместе с Метрикой. Оставьте пустым, если не нужен.</div>
