                    ...
                    <form method="POST" action="{{ route('admin.seo.redirects.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="status_code" name="status_code" class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                <option value="301" {{ old('status_code', '301') === '301' ? 'selected' : '' }}>301 — постоянный</option>
                                <option value="302" {{ old('status_code') === '302' ? 'selected' : '' }}>302 — временный</option>
                                <option value="307" {{ old('status_code') === '307' ? 'selected' : '' }}>307 — временный (сохранить метод)</option>
                                <option value="308" {{ old('status_code') === '308' ? 'selected' : '' }}>308 — постоянный (сохранить метод)</option>
                            </select>
                        ...
                        <div class="mb-6">
                            <label class="inline-flex items-center">
                                ...
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:ring-indigo-500">
