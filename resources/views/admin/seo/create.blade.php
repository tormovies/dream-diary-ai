                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.seo.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="title" name="title" type="text" class="mt-1 block w-full" :value="old('title')" placeholder="Например: {dream_title} — {date} | {site_name}" />
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="description" name="description" rows="3" class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('description') }}</textarea>
                            <x-input-error class="mt-2" :messages="$errors->get('description')" />
                        </div>

                        <div class="mb-6">
                            <x-input-label for="h1" :value="__('H1 (шаблон)')" />
                            <x-text-input id="h1" name="h1" type="text" class="mt-1 block w-full" :value="old('h1')" />
                            <x-input-error class="mt-2" :messages="$errors->get('h1')" />
                        </div>

                        <div class="mb-6">
                            <x-input-label for="h1_description" :value="__('Описание под H1 (опционально)')" />
                            <textarea id="h1_description" name="h1_description" rows="2" class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('h1_description') }}</textarea>
                            <x-input-error class="mt-2" :messages="$errors->get('h1_description')" />
                        </div>

                        <div class="mb-6">
                            <x-input-label for="keywords" :value="__('Keywords (опционально)')" />
                            <x-text-input id="keywords" name="keywords" type="text" class="mt-1 block w-full" :value="old('keywords')" placeholder="ключевое слово 1, ключевое слово 2" />
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="og_title" name="og_title" type="text" class="mt-1 block w-full" :value="old('og_title')" />
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="og_description" name="og_description" rows="2" class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('og_description') }}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="og_image" name="og_image" type="text" class="mt-1 block w-full" :value="old('og_image')" placeholder="https://example.com/image.jpg" />
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Или загрузите файл ниже</p>
                            <x-input-error class="mt-2" :messages="$errors->get('og_image')" />
                        </div>

                        <div class="mb-6">
                            <x-input-label for="og_image_file" :value="__('Загрузить OG Image')" />
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="priority" name="priority" type="number" min="0" max="100" value="0" class="mt-1 block w-full" :value="old('priority', 0)" />
