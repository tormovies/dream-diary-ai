...
return [
     ...
     * Промпт для системы
     */
    'system_prompt' => 'Ты — универсальный аналитик сновидений. Проанализируй сон с учётом указанного контекста, используя мульти-традиционный подход. Не используй англицизмы, сокращения и аббревиатуры. Если термин имеет английское происхождение — дай русский эквивалент. Пример: "reality check" → "проверка реальности", "lucidity" → "осознанность", "ПР" → "проверка реальности" ... Весь ответ на русском языке в унифицированном JSON формате.',
        ...
        'sections_configuration' => [
            'dream_metadata' => [
                ...
                'field_guidelines' => [
                    ...
                    'emotional_tone' => 'Основной эмоциональный фон: нейтральный, тревожный, радостный, исследовательский и т.д.',
