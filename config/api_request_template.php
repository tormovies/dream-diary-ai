...
return [
     ...
     * Промпт для системы
     */
    'system_prompt' => 'Ты — универсальный аналитик сновидений. Проанализируй сон с учётом указанного контекста, используя мульти-традиционный подход. Весь ответ на русском языке в унифицированном JSON формате.',
